...
func (c *Controller) List(ctx *gin.Context) {
	...
	items, page, err := c.svc.List(ctx.Request.Context(), &req.RequestPaginate, req.IsActive, schoolID, memberID)
	if err != nil {
		c.handleServiceError(ctx, log, err, "member-guardian-list-failed")
		return
	}
...
func (c *Controller) MemberGuardiansList(ctx *gin.Context) {
	c.List(ctx)
}

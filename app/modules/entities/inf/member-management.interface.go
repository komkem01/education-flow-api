...
type MemberManagementEntity interface {
	...
	ListMemberManagements(ctx context.Context, req *base.RequestPaginate, isActive *bool, memberID *uuid.UUID, departmentID *uuid.UUID) ([]*ent.MemberManagement, *base.ResponsePaginate, error)
